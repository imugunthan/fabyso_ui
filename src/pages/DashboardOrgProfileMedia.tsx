...
const DashboardOrgProfileMedia = () => {
  const videoTourData = [
    {
          ...
          <div className="org-profile__main p-8">
            <div className="flex -mx-4">
              <div className="col-9 px-4">
                ...
                <div className="card-box card-box--border-grey p-6 mt-6">
                  <div className="flex flex-wrap -mx-3">
                    {videoTourData.map((item, index) => (
                      <div key={index} className="col-4 px-3 mb-6">
...
export default DashboardOrgProfileMedia;
