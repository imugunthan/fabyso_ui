...
const BuyersOnboardingContactInfo = () => {
  ...
  return (
    <section className="onboarding-module">
      ...
      <div className="onboarding__body">
          ...
          <div className="onboarding__form__main mt-8">
            <div className="flex -mx-2 input-field-wrapper mb-4">
              ...
              <div className="col-3 px-2">
                <label className="input-field-label">Land line</label>
                <input
                  type="text"
                  className="input-field input-field--h40 w-full"
                  placeholder="Enter your land line"
                />
              </div>
              <div className="col-3 px-2">
        ...
        <button className="btn btn--text px-6 py-2 mt-1">Skip</button>
      </div>
    </section>
  );
};

export default BuyersOnboardingContactInfo;
