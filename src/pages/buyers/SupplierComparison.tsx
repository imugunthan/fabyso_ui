  ...
  return (
    <section className="dashboard-wrapper">
      ...
      <main className="dashboard__main dashboard__main--org-profile">
        ...
        <section className="compare-supplier show">
          <div className="compare-supplier__header">
            <div className="flex items-center justify-between">
              <h3 className="text-xl font-semibold pr-5">Compare</h3>
              <div className="flex items-center justify-center w-6 h-6 cursor-pointer">
                <img src={close} alt="close" />
              </div>
            </div>
          </div>
          <div className="compare-supplier__body">
            <div className="flex -mx-3">
              {compareData.map((item, index) => (
                <div
                  key={index}
                  className="col-3 px-3 flex-shrink-0"
                  style={{ borderRight: "1px solid #B7BDC6" }}
                >
                  ...
                  <div className="flex items-center mt-6">
                    <img
                      src={starRating}
                      alt="star-rating"
                      className="mr-2 mr-not-last-child"
                    />
                    <img
                      src={starRating}
                      alt="star-rating"
                  ...
                  <div className="flex items-center mt-6">
                    <span className="text-xl" style={{ color: "#252525" }}>
                      $ 32
                    </span>
                    <span className="text-xl ml-6" style={{ color: "#252525" }}>
                      10 days
                    </span>
                  </div>
                  <p className="text-sm font-light leading4 mt-6">
                    Elevate your style with our impeccably crafted shirt,
                    blending timeless design and premium comfort for a
                    statement.
                  </p>
                  <div className="flex items-center mt-6">
                    <button className="btn btn--primary btn--h32 px-3 flex-1">
                      Shortlist
                    </button>
                    <button className="btn btn--h32 px-3 flex-1 ml-3 whitespace-nowrap">
                      View Proposal
                    </button>
                  </div>
                </div>
