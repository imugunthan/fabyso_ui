...
import users from "../../assets/icons/user-white.svg";
...
const DashboardAsideMenuAdmin: React.FC = () => {
  const navItems: NavItem[] = [
    { id: 1, icon: home, title: "Home" },
    { id: 2, icon: orders, title: "Suppliers" },
    { id: 3, icon: enquiries, title: "Buyers" },
    { id: 4, icon: users, title: "Users" },
  ];
...
export default DashboardAsideMenuAdmin;
